...
<body>
    ...
    @endforeach
        ...
        <div id="show_account" class="flex-col justify-center items-center w-full h-screen p-5 hidden">
            <div class="flex flex-col border w-[600px] h-screen overflow-y-auto rounded-md bg-[#2D2D2D] gap-[10px]">
            ...
            <div class="flex center gap-[70px] p-5 text-white"><img id="profile_image" alt="profile-photo" class="w-[70px] h-[70px] object-cover rounded-full">
            ...
            <div class="flex justify-between items-center gap-3 px-[100px]">
            ...
            <div id='activity' class="text-white h-full overflow-y-auto">
                <h1 id="no-post" class="text-3xl capitalize text-white font-light text-center">no post</h1>
            </div>
        </div>
    </div>

    <div id='followers_account' class="w-[300px] h-[200px] overflow-y-auto hidden flex-col justify-between items-center bg-[#2D2D2D] border rounded-md relative -top-[300px] left-[500px]">
        <h1 class="capitalize text-[20px] text-center text-white font-light p-3">followers</h1>
    </div>
    <div id='followings_account' class="w-[300px] h-[200px] overflow-y-auto hidden flex-col justify-between items-center bg-[#2D2D2D] border rounded-md relative -top-[300px] left-[500px]">
