...
<body>
    ...
    @endforeach
            ...
            <div>
              @if(Auth::check())
              <a href="{{URL('logout')}}"  class="text-3xl opacity-35 p-3 duration-200 hover:opacity-100"
        ...
        <div class="flex flex-col justify-center items-center w-full h-screen p-5">
            ...
            <div class="flex center gap-[70px] p-5 text-white"><img id="profile_image" src="{{ $account->image }}" alt="profile-photo" class="w-[70px] h-[70px] object-cover rounded-full">
    ...
    <div id='followers_account' class="w-[300px] h-[200px] overflow-y-auto hidden flex flex-col justify-between items-center bg-[#2D2D2D] border rounded-md absolute top-[300px] left-[500px]">
    ...
    <div id='followings_account' class="w-[300px] h-[200px] overflow-y-auto hidden flex flex-col justify-between items-center bg-[#2D2D2D] border rounded-md absolute top-[300px] left-[550px]">
